...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Informe de Nueva Autorización Ticket <br>
                {{ $data['folio'] }} <br>
                {{ $data['casa'] }} -  {{ $data['area'] }}
            </h1>
            ...
            <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Detalle</th>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Descripción</th>
            ...
            <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Fecha Compromiso</th>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Monto Cotizado</th>
            ...
            <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Foto Evidencia Obligatotia</th>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Foto Evidencia Extra</th>
                        <th style="background-color: #107c41; color: #ffffff; text-align: center;">Foto Evidencia Extra</th>
