    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="background-color: #0058a3; color: #ffffff; text-align: center;">Detalle</th>
                        <th style="background-color: #0058a3; color: #ffffff; text-align: center;">Descripción</th>
            ...
            <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="background-color: #0058a3; color: #ffffff; text-align: center;">Foto Evidencia Obligatotia</th>
                        <th style="background-color: #0058a3; color: #ffffff; text-align: center;">Foto Evidencia Extra</th>
                        <th style="background-color: #0058a3; color: #ffffff; text-align: center;">Foto Evidencia Extra</th>
