<table>
    <thead>
        <tr>
            ...
            <th colspan="2" style=" color: #000000; background-color: #28a745;" valign='middle' align='center' bgcolor='#28a745'>
                FINALIZADO<br>
                MES
            </th>
    ...
    <tbody>
        ...
        <tr>
            <td width="10"  valign='middle ' align='center' bgcolor='#ffffff' style= "background-color: #ffffff;">
                SITIO
            </td>
            {{-- PENDIENTES --}}
            <td width="8"  valign='middle ' align='center' bgcolor='#ffffff' style= "background-color: #ffffff;">
                CANTIDAD
            </td>
            <td width="8"  valign='middle ' align='center' bgcolor='#ffffff' style= "background-color: #ffffff;">
                COTIZADO<br>
            ...
            <td width="12"  valign='middle ' align='center' bgcolor='#ffffff' style= "background-color: #ffffff;">
                ACUMULADO<br>
                HISTORICO
            </td>
            <td width="10"  valign='middle ' align='center' bgcolor='#ffffff' style= "background-color: #ffffff;">
