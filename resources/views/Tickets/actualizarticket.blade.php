...
@section('contenido')
    @if ($ticket->ESTATUS_AUTORIZACION == 'SI' || $ticket->REINCIDENCIA == 'SI' || $ticket->AREA_RESPONSABLE == 'SEDENA' || $ticket->AREA_RESPONSABLE == 'SEMAR' || $ticket->DAÑO == 'Siniestro')
        <div class="container form-container">
            ...
            <form action=" {{ route('update.ticket', $ticket) }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="link_evidencia">Link Imagen Evidencia</label>
                        <input type="text" class="form-control" id="link_evidencia" name="link_evidencia" placeholder="Ingrese el link" required>
                    </div>

                    <div class="form-group col-md-6">
                        <label for="observaciones_finales">Observaciones Finales</label>
                        <textarea id="observaciones_finales" name="observaciones_finales" class="form-control" rows="1" maxlength="100" placeholder="Max 100 caracteres" required></textarea>
                    </div>
                </div>
                        ...
                        <div class="form-row mt-5">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="img-zoom-container">
                                    <img id="myimage_1" data-id="myimage_1" class="item-img img-fluid img-thumbnail" src="{{ asset("storage/tickets/evidencias/" . $ticket->FOTO_OBLIGATORIA)}}" alt="Foto No Registrada" >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <label for="foto_evidencia_1">Foto Evidencia</label><br>
                                <div class="img-zoom-container">
                                    <img id="myimage_2" data-id="myimage_2" class="item-img img-fluid img-thumbnail" src="{{ asset("storage/tickets/evidencias/" . $ticket->FOTO_2)}}" alt="Foto No Registrada"  >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <label for="foto_evidencia_1">Foto Evidencia</label><br>
                                <div class="img-zoom-container">
                                    <img id="myimage_3" data-id="myimag_3" class="item-img img-fluid img-thumbnail" src="{{ asset("storage/tickets/evidencias/" . $ticket->FOTO_3)}}" alt="Foto No Registrada"  >
                                </div>
                            </div>
