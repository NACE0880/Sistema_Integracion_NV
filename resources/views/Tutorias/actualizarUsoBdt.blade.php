                ...
                <div class="row g-3">
                    ...
                    <div class="row g-3 justify-content-center gap-5">
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control mb-3" id="estatus_registro_previo" name="estatus_registro_previo" placeholder="{{ $adt->usobdt($adt->ID_ADT)->ESTATUS_REGISTRO }}" readonly/>
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control mb-3" id="estatus_curso_previo" name="estatus_curso_previo" placeholder="{{ $adt->usobdt($adt->ID_ADT)->ESTATUS_OFERTA }}" readonly/>
                    ...
                    <div class="row g-3 justify-content-center gap-5">
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control mb-3" id="tipo_uso_previo" name="tipo_uso_previo" placeholder="{{ $adt->usobdt($adt->ID_ADT)->TIPO_USO }}" readonly/>
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control mb-3" id="poblacion_previa" name="poblacion_previa" placeholder="{{ $adt->usobdt($adt->ID_ADT)->MAYORIA_POBLACION }}" readonly/>
                    ...
                    <div class="row g-3 justify-content-center">
                        <div class="col-6">
                            ...
                            <textarea class="form-control mb-3" id="observaciones_previas" name="observaciones_previas" rows="3" placeholder="{{ $adt->usobdt($adt->ID_ADT)->OBSERVACIONES }}" readonly></textarea>
