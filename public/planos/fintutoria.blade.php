...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Informe de Cambios Realizados en la Tutoría <br>[NOMBRE BDT]</h1>
            <p>Estimado/a [NOMBRE RESPONSABLE],</p>
            <p>
            ...
            <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: justify;">Daño en [NUMERO] Sillas quedando un total de [NUMERO] funcionales. </td>

                    </tr>
                    <tr>
                        <td style="text-align: center;">Equipos de Cómputo</td>
                        <td style="text-align: justify;"> Equipos pc funcionales [NUMERO],[NUMERO] dañados,[NUMERO] faltantes <br>Laptop [NUMERO] funcionales, [NUMERO] dañados,[NUMERO] faltantes  </td>
