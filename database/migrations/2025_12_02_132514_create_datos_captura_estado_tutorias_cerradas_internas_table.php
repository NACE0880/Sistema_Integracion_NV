...
class CreateDatosCapturaEstadoTutoriasCerradasInternasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('datos_captura_estado_tutorias_cerradas_internas', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('datos_captura_estado_tutorias_cerradas_internas');
    }
}
