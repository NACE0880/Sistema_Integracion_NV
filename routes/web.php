...
Route::middleware(['auth', 'can:manage-users'])->group(function () {
    Route::get('/usuarios/inicio', 'ControladorPanelUsuarios@mostrarInicioUsuarios')->name('usuarios.inicio');
    Route::post('/usuarios/inicio/registro', 'ControladorPanelUsuarios@registrarUsuario')->name('usuarios.registro');
    Route::post('/usuarios/inicio/modificacion/{nombreClaveUsuario}', 'ControladorPanelUsuarios@modificarUsuario')->where('nombreClaveUsuario', '[A-Za-z0-9_-]+')->name('usuarios.modificacion');
    Route::post('/usuarios/inicio/eliminacion/{nombreClaveUsuario}', 'ControladorPanelUsuarios@eliminarUsuario')->where('nombreClaveUsuario', '[A-Za-z0-9_-]+')->name('usuarios.eliminacion');
    Route::get('/usuarios/inicio/registro/modificacion/usuarios', 'ControladorPanelUsuarios@mostrarRegistroModificaciones')->name('usuarios.registro.modificacion');
});
